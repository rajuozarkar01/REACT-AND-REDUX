...
const WeatherDisplay = () => {
  ...
  if (!weather || !weather.weather || !Array.isArray(weather.weather) || weather.weather.length === 0) {
    return <p className="text-gray-600 mt-3 text-center">No weather data available.</p>;
  }
  ...
  return (
    <div className="mt-6 p-6 rounded-lg shadow-lg text-center text-gray-900 bg-white/80 backdrop-blur-md">
